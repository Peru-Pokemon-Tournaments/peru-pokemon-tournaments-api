    ...
    public function run()
    {
        ...
        Game::factory()->createMany([
            [
                'name' => 'Pokemon Rojo',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '1'),
            ],
            [
                'name' => 'Pokemon Verde',
                'game_generation_id' =>
            ...
            [
                'name' => 'Pokemon Oro',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '2'),
            ],
            [
                'name' => 'Pokemon Plata',
                'game_generation_id' =>
            ...
            [
                'name' => 'Pokemon Rubí',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '3'),
            ],
            [
                'name' => 'Pokemon Zafiro',
                'game_generation_id' =>
            ...
            [
                ...
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '4'),
            ],
            [
                'name' => 'Pokemon Perla',
                'game_generation_id' =>
            ...
            [
                'name' => 'Pokemon Blanco',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '5'),
            ],
            [
                'name' => 'Pokemon Negro',
                'game_generation_id' =>
            ...
            [
                'name' => 'Pokemon X',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '6'),
            ],
            [
                'name' => 'Pokemon Y',
                'game_generation_id' =>
            ...
            [
                'name' => 'Pokemon Sol',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '7'),
            ],
            [
                'name' => 'Pokemon Luna',
                'game_generation_id' =>
            ...
            [
                'name' => 'Pokemon Espada',
                'game_generation_id' =>
                    $gameGenerations->firstWhere('generation', '8'),
            ],
            [
                'name' => 'Pokemon Escudo',
                'game_generation_id' =>
